...
{
	public static void SetPropertyValue(IndentedTextWriter writer, ILocalVariable parentVar, XmlName propertyName, INode valueNode, SourceGenContext context)
	{
	...
	public static string GetOrGetValue(ILocalVariable parentVar, IFieldSymbol? bpFieldSymbol, IPropertySymbol? property, INode node, SourceGenContext context)
	{
	...
	static bool CanSet(ILocalVariable parentVar, string localName, INode node, SourceGenContext context)
	{
	...
	static bool CanSetDynamicResource(IFieldSymbol? bpFieldSymbol, INode node, SourceGenContext context)
	{
		if (bpFieldSymbol == null)
			return false;
	...
	static void ConnectEvent(IndentedTextWriter writer, ILocalVariable parentVar, string localName, INode valueNode, SourceGenContext context)
	{
	...
	static void SetValue(IndentedTextWriter writer, ILocalVariable parentVar, IFieldSymbol bpFieldSymbol, INode node, SourceGenContext context)
	{
	...
	static bool CanGetValue(ILocalVariable parentVar, IFieldSymbol? bpFieldSymbol, bool attached, SourceGenContext context, out ITypeSymbol? propertyType)
	{
		propertyType = null;
		if (bpFieldSymbol == null)
			return false;
	...
	static void Set(IndentedTextWriter writer, ILocalVariable parentVar, string localName, INode node, SourceGenContext context)
	{
	...
	static void SetBinding(IndentedTextWriter writer, ILocalVariable parentVar, IFieldSymbol bpFieldSymbol, INode node, SourceGenContext context)
	{
	...
	static bool CanAdd(ILocalVariable parentVar, string localName, IFieldSymbol? bpFieldSymbol, bool attached, INode valueNode, SourceGenContext context)
	{
	...
	static void Add(IndentedTextWriter writer, ILocalVariable parentVar, XmlName propertyName, INode valueNode, SourceGenContext context)
	{
		var localName = propertyName.LocalName;
